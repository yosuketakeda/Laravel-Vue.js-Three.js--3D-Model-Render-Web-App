        ...
        <div class="col-md-6 form-container mt-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <input name="admin" value="21" hidden>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="password" type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" value="" required placeholder="Password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="password-confirm" type="password" class="form-control form-control-lg" name="password_confirmation" value="" required placeholder="Confirm Password">
                            </div>
                        </div>
            ...
            <div class="sign-up-footer text-center">
                <div class="log-in mb-2">
                    Already have an account?<a href="/admin" class="ml-2">Log in</a>
                </div>                
            </div>
        </div>
    </div>
